...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appMood_Mix)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appMood_Mix))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_appMood_Mix)() {
    return 1;
}
